...
// Fallback testimonials (from original mock data)
  ...
  useEffect(() => {
    const fetchTestimonials = async () => {
      try {
        ...
        setError('Failed to load latest testimonials, showing cached content');
    ...
    <section id="testimonials" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          {error && (
            <div className="mt-4 text-sm text-amber-600 bg-amber-50 rounded-lg px-4 py-2 inline-block">
              {error}
            </div>
          )}
        </div>
